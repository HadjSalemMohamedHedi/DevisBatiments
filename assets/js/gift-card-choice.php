			 ...
			 function delItem(id){
											...
											if(a){
												...
												$.ajax({
													type: "GET",
													dataType:"html",
													url: "./includes/delete-object.php?object=gift_card_choice&id_gift_card_choice="+id,
...
function transform(id)
                                                {
                                                    ...
                                                    jQuery.ajax({
                                                        url: "gift-transform.php?id_gift_card_choice="+id,
...
<!---->
		 ...
		 function EditgiftCard(id)
                                                {
                                                    ...
                                                    jQuery.ajax({
                                                        url: "gift-card-edit.php?id_gift_card_choice="+id,
                                                        success: function(response)
         ...
         <div class="modal fade" id="ultraModal-add">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                        	<form id="gift-card-add" class="" action="./includes/validate-gift.php" method="post">
        ...
        <div class="modal" id="ultraModal-transform" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
                                                    <div class="modal-dialog animated bounceInDown">
                                                        <div class="modal-content">
                                                        	<form id="gift-transform" class="" action="./includes/validate-gift.php" method="post">
    ...
    if ($.isFunction($.fn.validate)) {
		...
		$('#gift-card-add').validate({
            ...
            submitHandler: function(form) {
				...
				var action = $('#gift-card-add').attr('action');

				$('#submit-add')
					
		
				$.post(action, $('#gift-card-add').serialize(),
					function(data){
						$('#msg-add').html( data );
						$('#msg-add').slideDown();
						...
						$('#gift-card-add #submit-add').removeAttr('disabled');
						if(data.match('success') != null){
							
							$('#ultraModal-add').modal('hide');
							$('#msg-add').hide();
							window.setTimeout(function () {
										window.location.href = "manage-gift.php";
							}, 500);
	...
	$('#gift-transform').validate({
            ...
            submitHandler: function(form) {
				...
				var action = $('#gift-transform').attr('action');

				$('#submit-transform')
					
		
				$.post(action, $('#gift-transform').serialize(),
					function(data){
						$('#msg-transform').html( data );
						$('#msg-transform').slideDown();
						
						$('#gift-transform #submit-transform').removeAttr('disabled');
						if(data.match('success') != null){
