...
if(isset($_GET['action']) && $_GET['action']=='delete') {
	...
	if(!isset($_GET['id']) || !is_numeric($_GET['id'])) {
		...
		redirect(ROOT_URL.'demandes-en-attente.php');
	}

	if($db->update('demandes',array('statut'=>'deleted'),$_GET['id'])) {
		$_SESSION['notification'] = array('type'=>'succes','msg'=>'La demande a été supprimé avec succès');
...
/*delete trash*/
	...
	if(!isset($_GET['id']) || !is_numeric($_GET['id'])) {
		$_SESSION['notification'] = array('type'=>'error','msg'=>'Id invalide');
		redirect(ROOT_URL.'demandes-en-attente.php?trash=true');
	}
...
/*restore trash*/
	...
	if($db->update('demandes',array('statut'=>''),$_GET['id'])) {
		$_SESSION['notification'] = array('type'=>'succes','msg'=>'La demande a été restauré avec succès');
	} else {
		$_SESSION['notification'] = array('type'=>'error','msg'=>'Il y a eu un problème S\'il vous plaît essayez de nouveau.');
	}
	redirect(ROOT_URL.'demandes-en-attente.php?trash=true');
			...
			<div class="modal-dialog" style="width:40%;">
				<div class="modal-content">
					...
					<div class="modal-header">
 					...
 					<div class="modal-body" > Voulez-vous changer le statut de la demande en "Traitée" ? </div>
...
<script type="text/javascript">
	...
	var oTable03 = $('#drillDownDataTable').dataTable({
		...
		"aaSorting": [[ 1, "asc" ]],
		"bProcessing": true,
		"sAjaxSource": "table/demandes-en-attente.php<?php echo $ajax_filter ?>",
		"aoColumns": [
		{ "mDataProp": "client" },
		{ "mDataProp": "Ref" },
		{ "mDataProp": "tableau" },
		...
		tableElement.dataTable({
			...
			<script type="text/javascript">
				...
				function delItem(id){
					...
					var a = confirm("Voulez-vous vraiment placer la demande dans la Corbeille?");
					if(a){
				...
				function delTrash(id){
					...
					var a = confirm("Voulez-vous vraiment supprimer définitivement la demande?");
					if(a){
