...
*/
	...
	$path = '../../../images-products/'.$id_product.'/'; // upload directory
	$pathToSave = 'images-products/'.$id_product.'/'; // upload directory
	$path_s = '../../../images-products/'.$id_product.'/s/'; // upload director
	...
	if(isset($_FILES['image']))
	{
		...
		{					
			...
			$pathToSave = $pathToSave.strtolower($final_image);	
			...
			if(move_uploaded_file($tmp,$path)) 
			{
				...
				$_SESSION['images-product'][]=$pathToSave;
						...
						<table class="table table-striped">
							...
							<tbody>
								<?php foreach ($_SESSION['images-product'] as $img){ 
									...
									<tr>
										<th scope="row"></th>
										<td><img src="https://hydrex-international.com/<?php echo $img?>" style="width:150px;"></td>
