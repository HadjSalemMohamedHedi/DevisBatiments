<?php
	...
	$id_colonne=$_SESSION['id_colonne'];
	...
	$path = 'icon-colonnes/'.$id_colonne.'/'; // upload directory
	...
	if (isset ($_GET['delete'])){
		$k=0;
		unlink($_SESSION['icon-colonne'][$k]);
		$_SESSION['icon-colonne'][$k]='-1';
			...
			<div class="row fileupload-buttonbar">
				...
				<div class="col-lg-10" style="margin-top:10px;">
					...
					<table class="table table-striped">
						...
						<tbody>
							<?php foreach ($_SESSION['icon-colonne'] as $img){ 
								//echo "<br>".$img;
								if ($img!='-1'){
								?>
								<tr>
									<th scope="row"></th>
									<td><img src="<?php echo $img?>" style="    max-width: 150px;"></td>
