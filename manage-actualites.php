<?php
	...
	if(isset($_GET['action']) && $_GET['action']=='delete') {
		...
		if(!isset($_GET['id']) || !is_numeric($_GET['id'])) {
			...
			redirect(ROOT_URL.'manage-actualites.php');
		}
		
		if($db->update('actualites',array('deleted'=> 1),$_GET['id'])) {
			$_SESSION['notification'] = array('type'=>'succes','msg'=>'L\'actualité a été archiivé avec succès');
								...
								<nav class="navbar-default">
									<div class="container-fluid">
										...
										<button type="button" class="btn btn-default navbar-btn btn-icon btn-add-product" data-toggle="modal" onclick="Add();">
											 <i class="fa fa-plus-square"></i> &nbsp; <span>Ajouter une actualité</span>
											</button>
									</div>
									<!-- /.container-fluid --> 
								</nav>
					...
					<div class="col-lg-12">
						<section class="box ">
							<header class="panel_header">
								<h2 class="title">Liste des actualités</h2>
							</header>
				...
				<div class="modal-content">
					<form id="form-add" class="" action="./module_ajax/actualites/validate.php" method="post">
						<div class="modal-header">
							...
							<h4 class="modal-title">Ajouter une actualité</h4>
						</div>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<form id="form-edit" class="" action="./module_ajax/actualites/validate.php" method="post">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
							<h4 class="modal-title">Modifier l'actualité</h4>
						</div>
		...
		/**************** DRILL DOWN DATATABLE ****************/
			...
			<script type="text/javascript">
				...
				function delTrash(id){
					...
					var a = confirm("Voulez-vous vraiment supprimer définitivement cette actualité?");
					if(a){
						...
						function(data){
							...
							if(data.match('success') != null){
								...
								window.setTimeout(function () {
									...
									$('#msg-add').hide();
									window.location.href = "manage-actualites.php";
								}, 1000);
