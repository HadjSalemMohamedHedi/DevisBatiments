<?php include_once '../../includes/config.inc.php';
	...
	$product_table_rows_fr = $db->get_rows("SELECT  product_table_charge_fr.* FROM product_table_charge_fr WHERE statut = 1 and id_product = ".$id_product." order by rang");
					...
					<?php 
						...
						if (count($product_table_rows_fr) > 0) 
						{
							...
							<tr id="line-<?php echo $row;?>">
								...
								<th class="col-charge_1"  	id="col-charge_1-<?php echo $row;?>"	><?php echo $product_table_rows['charge_1'];?></th>
								<th class="col-fleche_1"  	id="col-fleche_1-<?php echo $row;?>"	><?php echo $product_table_rows['fleche_1'];?></th>
								<th class="col-charge_2"  	id="col-charge_2-<?php echo $row;?>"	><?php echo $product_table_rows['charge_2'];?></th>
								<th class="col-fleche_2"  	id="col-fleche_2-<?php echo $row;?>"	><?php echo $product_table_rows['fleche_2'];?></th>
								<th class="col-charge_3"  	id="col-charge_3-<?php echo $row;?>"	><?php echo $product_table_rows['charge_3'];?></th>
								<th class="col-fleche_3"  	id="col-fleche_3-<?php echo $row;?>"	><?php echo $product_table_rows['fleche_3'];?></th>
								<th class="col-charge_4"  	id="col-charge_4-<?php echo $row;?>"	><?php echo $product_table_rows['charge_4'];?></th>
								<th class="col-fleche_4"  	id="col-fleche_4-<?php echo $row;?>"	><?php echo $product_table_rows['fleche_4'];?></th>
...
<script>
	...
	var total_line=<?php echo $all_table_rows;?>;
 	...
 	function show_bloc_add_line(){
		...
		input='<input type="text" class="form-control" id="col-charge_4-'+total_line+'" name="col-charge_4-'+total_line+'"  >';
		var th='<th class="col-charge_4">'+input+'</th>';
		tr+=th;
		
		input='<input type="text" class="form-control" id="col-fleche_4-'+total_line+'" name="col-fleche_4-'+total_line+'"  >';
		var th='<th class="col-fleche_4">'+input+'</th>';
		tr+=th;
	...
	v=  $("#col-charge_4-"+line_id).val();	 
	tr+='	<th class="col-charge_4" id="col-charge_4-'+line_id+'" >'+v+'</th>';
	
	v=  $("#col-fleche_4-"+line_id).val();	 
	tr+='	<th class="col-fleche_4" id="col-fleche_4-'+line_id+'" >'+v+'</th>';
	...
	var id_column_value="col-charge_4-"+line_id;
	var column_value=  $("#"+id_column_value).text();	
	input='<input type="text" class="form-control" id="col-charge_4-'+line_id+'" name="col-charge_4-'+line_id+'"  value ="'+column_value+'" >';
	var th='<th class="col-charge_4">'+input+'</th>';
	tr+=th;
	
	var id_column_value="col-fleche_4-"+line_id;
	var column_value=  $("#"+id_column_value).text();	
	input='<input type="text" class="form-control" id="col-fleche_4-'+line_id+'" name="col-fleche_4-'+line_id+'"  value ="'+column_value+'" >';
	var th='<th class="col-fleche_4">'+input+'</th>';
	tr+=th;
	...
	//charge_4
	id_column="charge_4";
	id_column_value="col-charge_4-"+line_id;
	column_value=  $("#"+id_column_value).text();	
	tab[k] = new Array();
	tab[k]['id_column']=id_column;
	tab[k]['value']=column_value;
	...
	//fleche_4
	id_column="fleche_4";
	id_column_value="col-fleche_4-"+line_id;
	column_value=  $("#"+id_column_value).text();	
	tab[k] = new Array();
	tab[k]['id_column']=id_column;
	tab[k]['value']=column_value;
...
jQuery.ajax({
	type: "POST",
	url: "module_ajax/products/validate_table_charge.php",
