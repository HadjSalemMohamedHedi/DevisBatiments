...
if(isset($_GET['id']) && is_numeric($_GET['id'])){
  ...
  $today = date("Y-m-d");
  if(!$db->update('ordered_hx',array('state'=>'Livrée', 'date_traitement'=>$today),$commande['id'])){
    echo 'error';
  }else{
    $_SESSION['notification'] = array('type'=>'succes','msg'=>'La commande a été livrée');
    //send_mail_to_client( $client['email'], $client['firstName'], $client['lastName'], $commande['ref_commande'], $table_pack, $commande['total'], $commande['counts_liv'], $commande['type_paiement'], $total, $client['address'], $client['country'], $client['cplocalite'], $client['phone']);
  }
      ...
      <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable" style="table-layout: fixed;max-width:100% !important;width: 100% !important;min-width: 100% !important;">
        <tr>
          <td align="center" valign="top" id="bodyCell">
                                ...
                                <tr>
                                  <td align="center" valign="top">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                      <tr>
                                        <td valign="top" class="textContent">
                                          <h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:16px;text-align:left;">Bonjour '.$nom.' '.$prenom.',</p></h3>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="500" class="flexibleContainer">
                          ...
                          <table cellspacing="0" cellpadding="6" border="1" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;width:100%;font-family:Helvetica,Roboto,Arial,sans-serif">
                            ...
                            <tbody>'.$table_pack.' </tbody>
                              <tfoot>
                                <tr>
                                <th scope="row" colspan="2" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left;border-top-width:4px">Sous-total&nbsp;:</th> 
                                ...
                                <tr>
                                <th scope="row" colspan="2" style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">Expédition&nbsp;:</th>
                                          ...
                                          <table class="flexibleContainerBoxNext" border="0" cellpadding="0" cellspacing="0" width="210" style="max-width: 100%;">
                                            <tr>
                                              <td width="100%" align="center" style="font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:18px;color:#7b7b7f;text-align:center;padding:0 0 0 0">
                                                ...
                                                <span style="font-weight:bold;color:#ec008c">À très bientôt sur Hydrex International !</span><br>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" bgcolor="#e30613">
              <tbody>
                <tr style="height: 20px;"><td align="center" valign="top"></td></tr>
              </tbody>
            </table>
            <table border="0" cellpadding="0" cellspacing="0" width="600" bgcolor="#e30613">
              <tbody>
                                  ...
                                  <td align="center" valign="top">
                                    <table border="0" cellpadding="0" cellspacing="0" align="center">
                                      <tbody>
                                        <tr>
                                          <td valign="top">
                                            <span style=" ">Email : <a href="mailto:hydrex@hydrex.fr" target="_blank">hydrex@hydrex.fr</a></span>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td valign="top">
                              ...
                              <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                <tr>
                                  <td valign="top" bgcolor="#E1E1E1">
                                    ...
                                    <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                      <div>Copyright &#169; 2021 <a href="https://hydrex-international.com" style="color: #676767;text-decoration: none;">hydrex@hydrex.fr</a>. Tous les droits sont réservés.</div>
                                    </div>
