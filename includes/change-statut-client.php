...
if(isset($_GET['object'])&& $_GET['object']!=='' &&  isset($_GET['id'])&& is_numeric($_GET['id'])){
	...
	if( $_GET['object'] == 'clients'){
		...
		if(!$db->update($_GET['object'],array('status'=>$active),$_GET['id'])){
			echo 'error';
		}else{
			echo 'success';
		}
...
<tr height="50"></tr>
 ...
 <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#848282" data-bgcolor="BodyBg" data-module="02-Browser part" style="background-color: #d2d0d0;">
  ...
  <tr>
    ...
    <blockquote>
      <b>Un nouveau compte a été créé</b>
    </blockquote>
   ...
   <tr>
      ...
      <span>
        ...
        <b>Pays: </b>'.$country.'
         ...
         <b style="margin-left: 30px;">Ville: </b>'.$ville.'

          <b style="margin-left: 30px;">Code postal: </b>'.$cplocalite.'
      </blockquote>
 ...
 <tr>
      ...
      <span>
         ...
         <blockquote>
        <b>Adresse de livraison: </b>'.$adressliv.'
      </blockquote>
 ...
 <tr>
      ...
      <span>
        ...
        <blockquote>
        <b>Spécialité: </b>'.$activity.'    <b> Société: </b>'.$societe.'
      </blockquote>
  ...
  <tr>
      ...
      <a href="http://hydrex-international.com/back-hydrex/nouvels-inscrits" class="btn btn-envoie" style="background: #e30613;color: #fff;padding: 15px;text-decoration: none;" target="_blank">Valider la demande</a>
