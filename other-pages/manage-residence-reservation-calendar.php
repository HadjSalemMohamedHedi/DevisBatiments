<?php
	...
	$residence_type = $db->get_rows("SELECT residence_type.* FROM residence_type WHERE  statut= 1 and deleted = 0");
            ...
            <section id="main-content" class=" ">
                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
					...
					<div style="margin:20px;    background: white;    padding: 5px; ">
							<?php foreach ($residence_type as $res){?>

						<button type="button" style="    height: 25px;   width: 25px;     margin-left:1%;padding: inherit;background:<?php echo $res["color"];?>;" class="btn "></button> <?php echo $res["titre_fr"];?>
 						<?php }?>
					</div>
			...
			<script src='calendar/lang-all.js'></script>
				...
				$(document).ready(function() {
					...
					$('#calendar').fullCalendar({
						...
						events: {
						url: 'module_ajax/reservation/calendar/get-events.php',
						error: function() {
						$('#script-warning').show();
						}
					},
					...
					jQuery.ajax({
						url: "module_ajax/reservation/details.php?id="+event.id,
