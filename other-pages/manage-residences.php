				...
				<section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
					<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
						<div class="page-title">
							<div class="pull-left">
								<h1 class="title">Gestion des Résidences</h1>
							</div>
						</div>
					</div>
								...
								<nav class="navbar navbar-default">
									<div class="container-fluid"> 
										...
										<div class="collapse navbar-collapse pull-right" id="bs-example-navbar-collapse-3">
											<button type="button" class="btn btn-default navbar-btn btn-icon" data-toggle="modal" onclick="Add();"> <i class="fa fa-plus-square"></i> &nbsp; <span>Ajouter une Résidence</span></button>
										</div>
					...
					<div class="col-lg-12">
						<section class="box ">
							<header class="panel_header">
								<h2 class="title pull-left">Liste des Résidences</h2>
		...
		/**************** DRILL DOWN DATATABLE ****************/
			/******************************************************/
				...
				var oTable03 = $('#drillDownDataTable').dataTable({
					...
					"aaSorting": [[ 1, "asc" ]],
					"bProcessing": true,
					"sAjaxSource": "table/residence.php<?php echo $ajax_filter ?>",
					"aoColumns": [
					{ "mDataProp": "id" },
					{ "mDataProp": "image" },
					{ "mDataProp": "type" },
			...
			<script type="text/javascript">
				...
				{
					window.location.href = "manage-residence-chambres.php?id_residence="+id;
				}
					function Edit_Prix(id)
				{
					window.location.href = "manage-residence-price.php?id_residence="+id;
				}
				function Edit(id)
				{
