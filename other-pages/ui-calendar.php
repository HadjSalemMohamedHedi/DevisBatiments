                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open">
                            <a href="javascript:;">
                                ...
                                <span class="title">Extra</span><span class="arrow open"></span>
                                <span class="label label-orange">NEW</span></a>
                        ...
                        <li class="">
                            <a href="javascript:;">
                                <i class="fa fa-envelope"></i>
                                <span class="title">Mailbox</span><span class="arrow "></span>
                                <span class="label label-orange">4</span></a>
                            <ul class="sub-menu" >
                                <li>
                        ...
                        <section class="box nobox">
                            <div class="content-body">
                                <div class="row">
                                    ...
                                    <div id='calendar' class="col-md-4 col-sm-9 col-xs-9"></div>
