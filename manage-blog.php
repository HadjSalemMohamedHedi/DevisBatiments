<?php
	...
	if(isset($_GET['action']) && $_GET['action']=='delete') {
		...
		if($db->update('actualites',array('deleted'=> 1),$_GET['id'])) {
			$_SESSION['notification'] = array('type'=>'succes','msg'=>'Le blog a été archiivé avec succès');
...
<html class=" ">
	...
	<body class=" ">
					...
					<div class="col-lg-12">
						<section class="box ">
							<header class="panel_header">
								<h2 class="title">Liste des blogs</h2>
							</header>
		...
		<div class="modal fade" id="ultraModal-add">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<form id="form-add" class="" action="./module_ajax/actualites/validateBlog.php" method="post">
		...
		<div class="modal fade" id="ultraModal-edit">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<form id="form-edit" class="" action="./module_ajax/actualites/validateBlog.php" method="post">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		...
		/**************** DRILL DOWN DATATABLE ****************/
			/******************************************************/
				...
				var oTable03 = $('#drillDownDataTable').dataTable({
					...
					"aaSorting": [[ 1, "asc" ]],
					"bProcessing": true,
					"sAjaxSource": "table/blog.php<?php echo $ajax_filter ?>",
					"aoColumns": [
					{ "mDataProp": "src_img" },
					{ "mDataProp": "titre" },
